...
# Menú principal limpio: portafolio, servicios, contacto y cita.
menu = '''<nav class="menu" id="main-menu"><a href="#proyectos">Portafolio</a><a href="#servicios">Servicios</a><a href="#contacto">Contacto</a><a class="menu-booking" href="https://calendar.app.google/h7XwWw9xizAmMNz38" rel="noopener" target="_blank">Agendar cita ↗</a></nav>'''
...
# Contacto es ahora la sección final 06.
