...
css = r'''
  ...
  @media(max-width:640px){.hero::after{background:linear-gradient(0deg,rgba(5,5,4,.76),rgba(5,5,4,.25) 65%)}.review-map{margin-top:1.5rem}.review-map iframe{height:210px}.footer-links{gap:.8rem 1.1rem}}
'''
